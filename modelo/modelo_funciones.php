...
function crear_nodo($descripcion,$tipo,$pos_x, $pos_y){
    $insert="INSERT INTO nodo(descripcion, tipo , pos_x, pos_y)
                       VALUES('$descripcion','$tipo', $pos_x, $pos_y); ";
    q($insert);
...
function asignar_sensor($camino_id,$sensor_id){
    $insert="INSERT INTO camino_sensor(camino_id, sensor_id)
                              VALUES('$camino_id','$sensor_id'); ";
    q($insert);
